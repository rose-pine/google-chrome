<p align="center">
    ...
    <h2 align="center">Rosé Pine for Google Chrome</h2>
</p>
...
Replace desired colors with your own RGB values in `manifest.json`, then follow `Manual Installation` above.
...
Themes contain values for Incognito Mode, but you may have to enable this behavior. Navigate to `chrome://flags` & enable `Allow widgets to inherit native theme from its parent widget.`
